    ...
    const fetchRegistrations = async () => {
      try {
        const res = await axios.get(
          "http://localhost:5000/api/upcommingregistrations"
        );
        setRegistrations(res.data); // should be array
      } catch (err) {
      ...
      <div className="d-flex min-vh-100 bg-light">
        ...
        <aside className="sidebar bg-dark text-white p-3">
          ...
          <nav className="nav flex-column gap-2">
            ...
            <Link
              href="/auth/admin/upcomming-Registration"
              className="nav-link text-white d-flex align-items-center gap-2 sidebar-link"
            >
              <Calendar size={18} />
              <span className="sidebar-text">Upcomming Registration</span>
            </Link>
          ...
          >
            ...
            <div className="row g-3 mb-4">
              {[
                ...
                {
                  title: "Registrations",
                  value: registrations.length, // registration count
                  link: "/auth/admin/upcomming-Registration", // registration dashboard link
                },
              ].map((stat, i: number) => (
