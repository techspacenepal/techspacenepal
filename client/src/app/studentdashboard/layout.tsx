...
export default function DashboardLayout({ children }: { children: ReactNode }) {
  ...
  const handleLogout = () => {
    ...
    router.push("/auth/studentLogin"); // 👈 redirect to login page
  };
  ...
  return (
    <>
      {/* Header */}
      <header className="w-100 sticky-top bg-light border-bottom d-flex align-items-center justify-content-between px-3 py-3">
        {/* Toggle */}
        <button
          className="btn btn-primary p-2 rounded d-flex align-items-center justify-content-center shadow-sm me-3"
          type="button"
      ...
      >
        ...
        <button
          ...
          className="btn d-block mb-3 text-start w-100 bg-transparent border-0 p-0 text-danger fw-semibold"
        >
