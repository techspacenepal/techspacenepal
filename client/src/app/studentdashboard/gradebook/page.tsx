...
//             A summary of your course grades and progress.
//           </caption>
//           <thead>
//             <tr>
//               <th style={{ width: "40%" }}>Course Name</th>
...
//             {grades.map((entry) => {
//               const grade = getGradeFromProgress(entry.progress || 0);
//               const status = entry.courseId.status;
...
//                       </div>
//                     ) : status === "published" ? (
//                       <div className="text-primary d-flex justify-content-center align-items-center gap-1">
//                         <TrendingUp size={16} />
//                         Ready to Start
//                       </div>
//                     ) : (
