...
//                     }}
//                 >
//                     Tech Space Nepal provides expert-led IT courses designed for career growth and real-world skills.
//                 </p>
...
//                             <div
//                                 key={c._id}
//                                 className={`col-10 col-sm-6 col-md-4 col-lg-3 course-col ${animate ? 'fade-slide-in' : ''}`}
...
//                                     <div className="card-body d-flex flex-column justify-content-between pt-0" style={{ minHeight: '117px' }}>
...
export default function AllCoursesPage() {
    ...
    // ✅ Converts course title to URL-friendly slug
    const slugify = (text: string | undefined | null) =>
        text
            ? text
                .toLowerCase()
    ...
    return (
        <div className="container my-5">
            ...
            {/* ✅ Courses List */}
            <div className="course-scroll-wrapper pb-0">
                <div className="row g-4 flex-nowrap flex-md-wrap">
                    {filteredCourses.length === 0 && (
                        <p className="text-center w-100 text-muted">No courses found.</p>
                    )}
